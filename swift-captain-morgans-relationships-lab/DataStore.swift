...
class DataStore {
	...
	func generateTestData() {
		...
		let pirate1 = NSEntityDescription.insertNewObjectForEntityForName("Pirate", inManagedObjectContext: managedObjectContext) as! Pirate
		pirate1.name = "Jack"
		...
		engine1.propulsionType = "Powered By Dreams"
		engine2.propulsionType = "Dark Matter"
		
		pirate1.ships?.insert(ship1)
		pirate1.ships?.insert(ship2) //= [ship1, ship2]
